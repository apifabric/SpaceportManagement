...
def declare_logic():
    ...
    # Derives the missions count for each astronaut from the AstronautMission junction table.
    Rule.count(derive=Astronaut.missions_count, as_count_of=AstronautMission, where=None)
