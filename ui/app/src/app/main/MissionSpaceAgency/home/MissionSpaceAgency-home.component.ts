...
@Component({
  selector: 'MissionSpaceAgency-home',
  templateUrl: './MissionSpaceAgency-home.component.html',
  styleUrls: ['./MissionSpaceAgency-home.component.scss']
})
export class MissionSpaceAgencyHomeComponent implements AfterViewInit {
