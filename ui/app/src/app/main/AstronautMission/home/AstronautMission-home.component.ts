...
@Component({
  selector: 'AstronautMission-home',
  templateUrl: './AstronautMission-home.component.html',
  styleUrls: ['./AstronautMission-home.component.scss']
})
export class AstronautMissionHomeComponent implements AfterViewInit {
