...
@Component({
  selector: 'Astronaut-home',
  templateUrl: './Astronaut-home.component.html',
  styleUrls: ['./Astronaut-home.component.scss']
})
export class AstronautHomeComponent implements AfterViewInit {
