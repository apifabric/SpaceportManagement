...
@Component({
  selector: 'AstronautTraining-home',
  templateUrl: './AstronautTraining-home.component.html',
  styleUrls: ['./AstronautTraining-home.component.scss']
})
export class AstronautTrainingHomeComponent implements AfterViewInit {
