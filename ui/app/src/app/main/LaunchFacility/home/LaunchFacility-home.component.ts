...
@Component({
  selector: 'LaunchFacility-home',
  templateUrl: './LaunchFacility-home.component.html',
  styleUrls: ['./LaunchFacility-home.component.scss']
})
export class LaunchFacilityHomeComponent implements AfterViewInit {
