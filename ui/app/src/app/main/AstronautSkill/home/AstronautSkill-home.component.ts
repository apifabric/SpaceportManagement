...
@Component({
  selector: 'AstronautSkill-home',
  templateUrl: './AstronautSkill-home.component.html',
  styleUrls: ['./AstronautSkill-home.component.scss']
})
export class AstronautSkillHomeComponent implements AfterViewInit {
