...
@Component({
  selector: 'Spaceport-home',
  templateUrl: './Spaceport-home.component.html',
  styleUrls: ['./Spaceport-home.component.scss']
})
export class SpaceportHomeComponent implements AfterViewInit {
