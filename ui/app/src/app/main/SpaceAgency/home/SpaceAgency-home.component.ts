...
@Component({
  selector: 'SpaceAgency-home',
  templateUrl: './SpaceAgency-home.component.html',
  styleUrls: ['./SpaceAgency-home.component.scss']
})
export class SpaceAgencyHomeComponent implements AfterViewInit {
