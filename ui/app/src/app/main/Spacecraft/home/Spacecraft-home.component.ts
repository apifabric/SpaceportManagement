...
@Component({
  selector: 'Spacecraft-home',
  templateUrl: './Spacecraft-home.component.html',
  styleUrls: ['./Spacecraft-home.component.scss']
})
export class SpacecraftHomeComponent implements AfterViewInit {
