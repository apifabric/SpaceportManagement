...
@Component({
  selector: 'MissionOutcome-home',
  templateUrl: './MissionOutcome-home.component.html',
  styleUrls: ['./MissionOutcome-home.component.scss']
})
export class MissionOutcomeHomeComponent implements AfterViewInit {
