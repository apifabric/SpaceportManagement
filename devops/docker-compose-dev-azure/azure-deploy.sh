...
resourcename="spaceportsystem"  # lower case, only
resourcegroup="spaceportsystem_rg"
...
# git clone https://github.com/apilogicserver/spaceportsystem.git
# cd spaceportsystem
...
az group create --name spaceportsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group spaceportsystem_rg --sku S1 --is-linux
az container create --resource-group spaceportsystem_rg --name spaceportsystem --image apilogicserver/spaceportsystem:latest --dns-name-label spaceportsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//spaceportsystem.westus.azurecontainer.io:5656'
